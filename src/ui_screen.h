#ifndef LSD_UI_SCREEN_H
#define LSD_UI_SCREEN_H
...
typedef struct ui_screen_vtable {
    ...
    /* 0x0A4 8006e7d4 */ void (*Unk40)(void *, char *, char *, char *);
    ...
    /* 0x0F8 8006e828 */ void (*Unk61)(void *, void *, void *);
...
typedef struct ui_screen {
    /* 0x00 */ ui_screen_vtable_t *vtable;
    /* 0x04 */ s32 m_Unk0;
    /* 0x08 */ s32 m_Unk1;
    /* 0x0C */ s32 m_Unk2;
    /* 0x10 */ s32 m_Unk3;
