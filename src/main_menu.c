...
static const char *g_MENU_BUTTON_STATES[3] = {
    "Off",
    "On",
    NULL
};

static void *D_80086CA8[7] = {
    NULL,
    NULL,
    (void *) 0x8080,
    NULL,
    (void *) 0x35,
    (void *) 0x39,
    &g_MENU_BUTTON_STATES
};

static void *D_80086CC4[6] = {
    NULL,
    NULL,
    NULL,
    NULL,
...
static const char *g_MENU_ITEMS[7] = {
    "START",
    "FLASHBACK",
    "SAVE",
    "LOAD",
...
static const void *D_80086D54[9] = {
    (void *) 0,
    (void *) 0,
    (void *) 0,
    (void *) 0x80505050,
...
// SHIFT-JIS
static char *g_SPACES = "\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x00";
static char *g_DAY_STR = "\x82\x6b\x82\x72\x82\x63\x81\x40\x81\x40\x81\x40\x82\x63\x82\x81\x82\x99\x82\x4f\x82\x4f\x82\x50\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x81\x40\x00";
...
void func_8004DF64(main_menu_t *This, s32 Unk) {
    ...
    This->m_MemoryCard->vtable->Unk26(
        This->m_MemoryCard,
        D_80011454,
        &D_80086D6C,
        *(u32 *)(This->m_Unk2 + 4),
...
void func_8004E0E4(main_menu_t *This) {
    ...
    This->m_MemoryCard->vtable->Unk29(
        This->m_MemoryCard,
        D_8008AA10, 
        g_DAY_STR,
        13,
        3,
        This->m_TextureHelper,
        This->m_RegionCode,
...
void func_8004E1C4(main_menu_t *This) {
    ...
    This->m_MemoryCard->vtable->Unk28(
        This->m_MemoryCard,
        D_8008AA10,
        g_DAY_STR,
        This->m_RegionCode,
