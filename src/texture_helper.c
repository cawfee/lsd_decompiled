...
extern gs_helper_t *func_80020C5C(void);
...
void texture_helper_set_loaded(texture_helper_t *This) { This->m_MaybeLoaded = 1; }
void texture_helper_get_tim_info(texture_helper_t *This, void *TIMData) {
    GsGetTimInfo((unsigned long *) (This->m_Image + 4), TIMData);
}
texture_helper_vtable_t *texture_helper_get_vtable(void) { return &g_TEXTURE_HELPER_VTABLE; }
