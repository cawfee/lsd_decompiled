...
typedef struct display_vtable {
    /* 0x000 8006c070 */ u32 value;
    /* 0x004 8006c074 */ void (*base_class_destructor)(void *);
    /* 0x008 8006c078 */ void (*Construct)(void *);
    /* 0x00C 8006c07c */ void (*base_class_cleanup)(void *);
    ...
    /* 0x040 8006c0b0 */ void (*display_reset)(void *);
    /* 0x044 8006c0b4 */ void (*display_init_gs)(void *, s16 *, s32);
    /* 0x048 8006c0b8 */ void (*display_do_vsync)(void *);
    /* 0x04C 8006c0bc */ void (*display_reset_vsync_count)(void *);
    /* 0x050 8006c0c0 */ void (*display_swap_disp_buffer)(void *);
    /* 0x054 8006c0c4 */ void (*display_get_active_buffer)(void *);
    /* 0x058 8006c0c8 */ void (*display_load_image)(void *);
    /* 0x05C 8006c0cc */ void (*display_store_image)(void *);
    /* 0x060 8006c0d0 */ void (*Unk23)(void *);
    /* 0x064 8006c0d4 */ void (*Unk24)(void *);
    /* 0x068 8006c0d8 */ void (*display_do_vsync_internal)(void *);
    /* 0x06C 8006c0dc */ void (*Unk26)(void *);
    /* 0x070 8006c0e0 */ void (*display_set_vblanks)(void *, s32);
    /* 0x074 8006c0e4 */ void (*display_get_vblanks)(void *);
    /* 0x078 8006c0e8 */ void (*Unk29)(void *, unsigned char *, s32);
    /* 0x07C 8006c0ec */ void *(*display_get_screen_size)(void *, void *);
    /* 0x080 8006c0f0 */ void (*Unk31)(void *, s32);
    /* 0x084 8006c0f4 */ void (*display_set_vsync_callback)(void *, void (*Callback)());
} display_vtable_t;
