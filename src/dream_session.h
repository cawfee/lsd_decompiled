...
typedef struct dream_session_vtable {
    ...
    /* 0x044 8008660c */ s32 (*dream_session_execute)(void *);
    ...
    /* 0x060 80086628 */ void (*Unk23)(void *, s32);
    ...
    /* 0x084 8008664c */ void (*on_link_code)(void *, void **, s32);
} dream_session_vtable_t;

typedef struct dream_session {
