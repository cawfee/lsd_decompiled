...
void func_800488E4(class_39094_t *This) {
    (*(void (**)(class_39094_t *))((s32)get_file_driver() + 8))(This);
...
void func_80048960(class_39094_t *This) {
  ...
  (*(void ( **)(class_39094_t *))((s32) get_file_driver() + 12))(This);
}
...
void func_800489B4(class_39094_t *This) {
    ...
    (*(void (**)(class_39094_t *))((s32)get_file_driver() + 0x64))(This);
}

void func_80048A68(class_39094_t *This) {
    (*(void ( **)(class_39094_t *))((s32) get_file_driver() + 116))(This);
    This->m_Unk10_1 = 0;
    This->m_Unk10_2 = 0;
    This->m_Unk9_2 = 0;
}
